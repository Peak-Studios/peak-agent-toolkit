...
The generation command creates one versioned `catalog/catalog.json`, the static HTTP export, and skill references. The MCP runtime imports that generated catalog and exposes only resources and read-only tools.
