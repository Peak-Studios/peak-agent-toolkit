...
describe("public catalog", () => {
  it("contains exactly the approved scripts", () => {
    expect(catalog.scripts.map((script) => script.id).sort()).toEqual(["peak-ai-npc", "peak-barbers", "peak-bridge", "peak-chess", "peak-clothingitems", "peak-police-report-writer", "peak-readme-generator", "peak-sprays", "peak-trucking"]);
  });
